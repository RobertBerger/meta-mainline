...
U_BOOT="u-boot-beagle-bone-black-ml.img"
...
# uEnv.txt
echo "+ cp mmc-uEnv-beagle-bone-black.txt ${BOOT_PART}/uEnv.txt"
cp mmc-uEnv-beagle-bone-black.txt ${BOOT_PART}/uEnv.txt

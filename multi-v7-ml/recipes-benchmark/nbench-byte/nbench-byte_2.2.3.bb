...
LIC_FILES_CHKSUM += " file://${THISDIR}/../../custom-licenses/nbench-byte;beginline=57;endline=66;md5=020ef579f8fa5746b7e307a54707834f"
SRC_URI += " file://${THISDIR}/../../custom-licenses/nbench-byte"
# <-- get rid of license warning

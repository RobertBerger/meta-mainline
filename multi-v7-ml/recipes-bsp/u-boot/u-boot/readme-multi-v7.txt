...
e.g.:
./mmc-core-image-minimal-dev-multi-v7.sh /media/boot uImage-multi-v7-ml.bin uImage-am335x-boneblack.dtb /media/rootfs core-image-minimal-dev-multi-v7-ml.tar.bz2 modules-multi-v7-ml.tgz

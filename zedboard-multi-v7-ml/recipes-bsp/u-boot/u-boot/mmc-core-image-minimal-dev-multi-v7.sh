...
U_BOOT="u-boot-zedboard-multi-v7-ml.img"
...
# uEnv.txt
echo "+ cp mmc-uEnv-multi-v7.txt ${BOOT_PART}/uEnv.txt"
cp mmc-uEnv-multi-v7.txt ${BOOT_PART}/uEnv.txt

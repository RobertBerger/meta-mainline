...
for BRANCH in master jethro-training-v4.4.x morty-training-v4.4.x pyro-training-v4.4.x pyro-training-v4.9.x rocko-training-v4.9.x rocko-training-v4.14.x sumo-training-v4.14.x
do
  echo "+ ----->"
  echo "+ cd ../../meta-mainline-top/meta-mainline-test/"
  cd ../../meta-mainline-top/meta-mainline-test/
